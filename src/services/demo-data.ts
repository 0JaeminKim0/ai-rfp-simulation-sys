...
export class DemoDataService {
  ...
  static getSamplePresentationEvaluation(companyName: string = '금고석유화학'): PresentationEvaluation {
    return {
      ...
      scores: {
        clarity: { 
          score: 85,     // 100점 척도 직접 점수
          score_5: 4,    // 원본 5점 만점 점수 (호환성용)
          score_100: 85, // 100점 만점 점수
        ...
        logic: { 
          score: 87,     // 100점 척도 직접 점수
          score_5: 4,    // 원본 5점 만점 점수 (호환성용)
          score_100: 87, // 100점 만점 점수
          comment: "통합→대응→실행 순서로 논리적 흐름 구성. 단계별 PoC 접근법이 체계적" 
        },
        creativity: { 
          score: 73,     // 100점 척도 직접 점수
          score_5: 3,    // 원본 5점 만점 점수 (호환성용)
          score_100: 73, // 100점 만점 점수
          comment: "안정적이고 검증된 방식 위주. 혁신적 아이디어보다는 실용적 접근 강조" 
        },
        credibility: { 
          score: 94,     // 100점 척도 직접 점수
          score_5: 5,    // 원본 5점 만점 점수 (호환성용)
          score_100: 94, // 100점 만점 점수
      ...
      total_score_5: 4.17, // (4+5+4+4+3+5)/6 - 5점 만점 (호환성용)
      total_score_100: 86.5, // (85+92+88+87+73+94)/6 - 100점 만점
      total_score: 86.5, // 기본은 100점 만점
      evaluation_date: new Date().toISOString()
    }
  }
}